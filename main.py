...
if stock_ticker:
    ...
    # Ensure column names are properly formatted (drop multi-index if present)
    ...
    if not stock_data.empty:
        ...
        # Plot predictions
        fig_pred = px.line(pred_df, x=pred_df.index, y="Predicted Close", title="Stock Price Prediction for Next Days")
        ...
        if st.sidebar.button("Send Email"):
            try:
                sender_email = "umeshpotha123@gmail.com"  # Replace with your email
                sender_password = "auskpglomcbtohoz"  # Replace with your email password
